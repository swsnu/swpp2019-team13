...
INSERT INTO `auth_user` VALUES (8,'pbkdf2_sha256$150000$IylIhwxYsjaf$Vel4RxcNDWamm2L1imnrFIdRyHhkDGlJM3N6EMpxcMk=',NULL,0,'user1','','','',0,1,'2019-11-01 11:18:38.060918'),(9,'pbkdf2_sha256$150000$YHXzJiDaJicL$sfkM6WBYalVGkU4IaqBhJ7oepHfEj2eDK7N5P+fikwg=',NULL,0,'user2','','','',0,1,'2019-11-01 11:19:46.456601'),(10,'pbkdf2_sha256$150000$R9uljSndwvKC$b4XGhjEY3LU+2xhWbNqRS94ViwPUs4zj3Mu16p9FG/A=',NULL,0,'user3','','','',0,1,'2019-11-01 11:20:23.688145');
...
CREATE TABLE `club4u_club` (
  ...
  `poster_img` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  `likes` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `club4u_club_category_id_0ffaa8f3_fk_club4u_category_id` (`category_id`),
  KEY `club4u_club_author_id_4594bec9_fk_club4u_userprofile_id` (`author_id`),
  CONSTRAINT `club4u_club_author_id_4594bec9_fk_club4u_userprofile_id` FOREIGN KEY (`author_id`) REFERENCES `club4u_userprofile` (`id`),
...
INSERT INTO `club4u_club` VALUES (1,'SNUStone',1,1,'SNU Best HearthStone Club','놀랄만큼\n쉽고\n재밌습니다!',NULL,5),(2,'SNUWOD',2,3,'SNU Best Training Club','근손실\n방지\n위원회',NULL,2),(3,'SNULOL',3,4,'SNU Best LOL Club','잉\n기모링\n믿고있었다구',NULL,4);
...
CREATE TABLE `club4u_preclub` (
  ...
  `auth_img` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `club4u_somoim` VALUES (1,'롤 소모임',1,4,'롤 조아 너무 조아','페이커\n검은수염\n팬싸인회 개최',10,2,3),(2,'책 책 책을 읽읍시다',2,3,'책벌레들 들어오세요','사실\n자는\n소모임임 ㅎㅎ;',20,10,2),(3,'아싸들 모여라',3,5,'나도 아싸임 ㅜㅜ','아싸들이\n모이면\n인싸가 된다\nㅇㅈ? ㅇㅇㅈ',15,12,3);
...
CREATE TABLE `club4u_userprofile` (
  ...
  KEY `club4u_userprofile_major_id_5400990a_fk_club4u_major_id` (`major_id`),
  ...
  CONSTRAINT `club4u_userprofile_major_id_5400990a_fk_club4u_major_id` FOREIGN KEY (`major_id`) REFERENCES `club4u_major` (`id`),
...
INSERT INTO `club4u_userprofile` VALUES (1,8,1,5,3,1),(2,9,6,48,2,5),(3,10,3,27,1,1);
...
-- Dump completed on 2019-11-01 20:45:48
