# Generated by Django 2.2.5 on 2019-11-13 16:20
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='application', to='club4u.UserProfile')),
            ],
        ),
        migrations.CreateModel(
            name='ShortTextForm',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order', models.IntegerField(default=0)),
                ('title', models.CharField(max_length=100)),
                ('choices', django_mysql.models.ListCharField(models.CharField(max_length=100), max_length=100, size=None)),
